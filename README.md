...
### Objective
Perform Exploratory Data Analysis (EDA) on unemployment data to uncover temporal and regional patterns, with a specific focus on the impact of the COVID-19 pandemic on unemployment rates.

### Key Features & Workflow
- **State-wise Analysis:** Visualized top states with the highest average unemployment rates using bar charts.
- **Time-Series Analysis:** Evaluated month-wise trends across major states to identify economic spikes during lockdown periods.
- **Pre-COVID vs. Post-COVID Comparison:** Derived distributional insights contrasting unemployment metrics before and after March 2020.
- **Correlation Heatmap:** Analyzed relationships between Estimated Unemployment Rate, Estimated Employed, and Labour Participation Rate.
